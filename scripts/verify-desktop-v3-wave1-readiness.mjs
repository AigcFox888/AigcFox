...
export function buildDesktopV3Wave1ReadinessHelpText() {
  return [
    ...
    "  The runner then enforces renderer runtime, LocalDatabase governance, Rust command governance, capability governance, and shared Tauri platform-config governance before lint / test / smoke proof steps.",
