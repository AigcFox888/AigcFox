...
export function buildDesktopV3Wave1ReadinessHelpText() {
  return [
    ...
    "  The runner then enforces renderer runtime, LocalDatabase governance, backend-client governance, runtime skeleton governance, runtime contract governance, Rust command governance, capability governance, shared Tauri platform-config governance, and updater governance before lint / test / smoke proof steps.",
